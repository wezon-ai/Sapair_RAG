...
#     def load_nodes(self):
#         """
#         Load nodes from JSON files in the data directory.
#         """
#         self.nodes = []
#         for json_file in Path(self.data_dir).glob("*.json"):
#             with open(json_file, 'r') as file:
#                 self.nodes.append(json.load(file))
        
#         logging.info(f"Loaded {len(self.nodes)} nodes from JSON files.")
...
#         """
#         points = []
#         for i, node in enumerate(tqdm(self.nodes, total=len(self.nodes))):
#             # Extract texts
